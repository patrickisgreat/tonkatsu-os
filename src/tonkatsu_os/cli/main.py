...
def cmd_analyze(args):
    ...
    from tonkatsu_os import RamanSpectralDatabase, AdvancedPreprocessor, EnsembleClassifier
...
def cmd_train(args):
    ...
    from tonkatsu_os import RamanSpectralDatabase, EnsembleClassifier
...
Examples:
  ...
  tonkatsu db-stats               # Show database stats
    ...
    parser.add_argument(
        "--version", 
        action="version", 
        version=f"Tonkatsu-OS {__version__}"
    )

...
class AcquisitionRequest(BaseModel):
    ...
    laser_power: Optional[float] = Field(None, ge=0.0, le=100.0, description="Laser power percentage")
...
class SyntheticDataRequest(BaseModel):
    samples_per_compound: int = Field(10, ge=1, le=100, description="Number of synthetic samples per compound")
